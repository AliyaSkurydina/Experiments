...
\begin{frame}{1.1. Регуляризованный метод Ньютона}
		...
		\scriptsize
		\let\thefootnote\relax\let\thefootnote\relax\footnotetext{\footnotesize 1. Бакушинский А. Б. Регуляризующий алгоритм на основе метода Ньютона -- Канторовича ... // ЖВМиМФ, 16:6 (1976). С. 1397--1604.}
...
%	$\alpha$-процессы для линейного  самосопряженного положительно определенного оператора  были предложены {\color{red}М.~А.~Красносельским и др. (1969)}. \\
	...
	\end{itemize}
	\let\thefootnote\relax\let\thefootnote\relax\footnotetext{\footnotesize Красносельский М. А., Забрейко Г. М., Забрейко П. П. и др. Приближенное решение операторных уравнений // М.: Наука, 1969.}
\end{frame}
...
\begin{frame}{Глава 3. Покомпонентные методы ньютоновского типа решения обратных структурных задач гравиметрии и магнитометрии}
	В третьей главе предлагаются покомпонентные методы типа Ньютона и типа Левенберга -- Марквардта и вычислительная оптимизация методов типа Ньютона. 
...
%	
	...
	\let\thefootnote\relax\let\thefootnote\relax\footnotetext{\footnotesize * Мартышко П.С., Акимова Е.Н., Мисилов В.Е. О решении структурной обратной задачи гравиметрии модифицированными методами градиентного типа // Физика земли. 2016. № 5. С. 82--86.}
