...
\begin{frame}{3.5. Задача 1 (сравнение методов типа Ньютона решения задачи гравиметрии в двухслойной среде)}
	...
	Модельная поверхность (слева) и приближенное решение (справа): $D=\{0\leqslant x\leqslant 270, \,\,0\leqslant y\leqslant 300\}$, \\ $  H=5,\,\,\Delta x=\Delta y=0.1,\,\,\Delta\sigma=0.2$ г/см$^3$.
\end{frame}
\begin{frame}
